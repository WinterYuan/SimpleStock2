...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">商品入库管理&gt;&gt;添加商品入库</span>
</div>
  ...
  <tr> 
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="red">*</font> 入库商品：</td>
          <td width="65%">
        ...
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="red">*</font> 入库人：</td>
          <td width="65%">
