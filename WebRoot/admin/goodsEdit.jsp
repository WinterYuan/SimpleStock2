...
$(document).ready(function(){
	 ...
	 $("#addBtn").bind('click',function(){
		...
		if(!num2.exec($("#paramsGoods\\.alarm_count").val())){
			alert('预警数量必须为数字');
			return;
		}
  ...
  <tr> 
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="red">*</font> 商品价格：</td>
          <td width="65%">
        ...
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="red">*</font>商品描述：</td>
          <td width="65%">
