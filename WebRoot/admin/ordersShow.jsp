...
{
   document.info.action="exportOrders.action";
   document.info.submit();
}
</script>
</head>
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">商品入库管理&gt;&gt;商品入库查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr class="listtitle">
     ...
     <td width="" align="center">入库数量</td>
     <td width="" align="center">入库人</td>
   ...
   <s:else>
   <tr>
     <td height="60" colspan="8" align="center"><b>&lt;不存在商品入库信息&gt;</b></td>
   </tr>
   </s:else>
