...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">商品出库管理&gt;&gt;出库汇总</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <s:else>
   <tr>
     <td height="60" colspan="5" align="center"><b>&lt;不存在出库汇总信息&gt;</b></td>
   </tr>
   </s:else>
