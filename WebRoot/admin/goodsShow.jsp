...
{
   document.info.action="exportGoods.action";
   document.info.submit();
}
</script>
</head>
  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <s:select id="paramsGoods.goods_type_id" name="paramsGoods.goods_type_id" value="%{#attr.paramsGoods.goods_type_id}" 
            ...
            预警状态：
      <s:select id="paramsGoods.alarm_flag" name="paramsGoods.alarm_flag" value="%{#attr.paramsGoods.alarm_flag}" 
      		list="#{'2':'已预警'}" listKey="key" listValue="value" 
      		cssClass="selectstyle" cssStyle="width:100px;" headerKey="0" headerValue="请选择">
      </s:select>&nbsp;&nbsp;
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <s:if test="#goods.goods_count lte #goods.alarm_count">
     <td width="" align="center" style="background-color:red"><s:property value="#goods.goods_count"/></td>
     </s:if>
     <s:else>
